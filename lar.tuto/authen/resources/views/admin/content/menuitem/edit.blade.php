    ...
    <div class="row">
        <div class="form-three widget-shadow">
            ...
            <form name="tag" action="{{url('admin/menuitems/'.$menu->id)}}" method="post" class="form-horizontal">
                ...
                <?php
                $params=(array) json_encode($menu->params);
                ?>
                    ...
                    <div class="col-sm-8">
                        <select name="param_1">
                            @foreach($shop_categories as $shop_category)
                                <?php $selected = ($shop_category->id == $params['param_1']) ? ' selected' : ' ' ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text"name="link" value="{{ $menu->icon }}" class="form-control1" id="focusedinput" placeholder="EX:fa fa-shop">
